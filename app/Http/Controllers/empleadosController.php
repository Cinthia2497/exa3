...
class empleadosController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        empleados::whereId($id)->update($data);

        return redirect('/empleados')->with('success', 'empleados modificado correctamente.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('/empleados')->with('success', 'empleados eliminado correctamente.');;
        //
    }
}
